                ...
                <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 24, paddingTop: 8 }}>
                    {phase === 'manipulate' ? (
                        <Animated.View entering={FadeInDown.delay(80)}>
                            {/* The assignment */}
                            <Text className="text-[20px] font-elms-bold italic text-dark mb-2 leading-snug">
                                You're a data journalist. Your editor wants a chart that proves:
                            </Text>
                            <View className="bg-dark rounded-2xl px-4 py-3.5 mb-6">
                                <Text className="text-[15px] font-elms-bold italic text-primary">
                            ...
                            <View className="bg-white border border-dark/10 rounded-2xl p-4 mb-2 items-center">
                                <Text className="text-[12px] font-elms-bold text-dark/50 mb-2 self-start">
                                    {scenario.title}
                                </Text>
                                <LineChart
                            ...
                            <Text className="text-[10px] font-elms-regular text-dark/30 mb-6">
                            ...
                            {/* Controls */}
                            <Text className="text-[13px] font-elms-bold text-dark mb-1">
                                Bend the chart
                            </Text>
                            <Text className="text-[11px] font-elms-regular text-dark/45 mb-4 leading-snug">
